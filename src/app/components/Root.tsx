      ...
      >
        <div className="max-w-4xl w-full mx-auto flex items-center gap-2.5 sm:gap-4">
          <button
            ...
            className="flex-1 h-13 sm:h-14 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-slate-950 font-medium text-base sm:text-xl rounded-xl shadow-lg shadow-orange-500/20 transition-all flex items-center justify-center gap-2.5 whitespace-nowrap active:scale-[0.98] border border-amber-300/40"
          >
          ...
          <a
            ...
            className="flex-1 h-13 sm:h-14 bg-[#25D366] hover:bg-[#20bd5a] text-slate-950 font-medium text-base sm:text-xl rounded-xl shadow-lg shadow-[#25D366]/20 transition-all flex items-center justify-center gap-2.5 whitespace-nowrap active:scale-[0.98]"
          >
