  ...
  return (
    <div className="min-h-screen flex flex-col w-full overflow-x-hidden">
      ...
      >
        ...
        <div className="w-14 h-14 rounded-full shadow-2xl shadow-green-500/40 flex items-center justify-center animate-pulse-slow hover:scale-105 transition-transform"
