    ...
    <div className="min-h-screen flex flex-col w-full overflow-x-hidden pb-16 sm:pb-0">
      ...
      >
        <button
          ...
          className="bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-slate-950 font-semibold px-5 sm:px-6 py-2.5 sm:py-3 rounded-full text-sm sm:text-base shadow-lg shadow-orange-500/30 transition-all flex items-center gap-2.5 whitespace-nowrap active:scale-95 border border-amber-300/40"
        >
        ...
        <a
          ...
          className="bg-[#25D366] hover:bg-[#20bd5a] text-slate-950 font-semibold px-5 sm:px-6 py-2.5 sm:py-3 rounded-full text-sm sm:text-base shadow-lg shadow-[#25D366]/30 transition-all flex items-center gap-2.5 whitespace-nowrap active:scale-95"
        >
