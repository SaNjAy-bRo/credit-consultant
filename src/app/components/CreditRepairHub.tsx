...
const spokeData: Record<string, any> = {
  ...
  "dispute-errors": {
    ...
    sections: [
      ...
      { heading: "Dispute Portals for All 4 Bureaus", body: <><p><strong>CIBIL:</strong> dispute.cibil.com</p><p className="mt-1"><strong>Equifax:</strong> equifax.co.in → Customer Support → Dispute</p><p className="mt-1"><strong>Experian:</strong> experian.in → Consumer Dispute Centre</p><p className="mt-1"><strong>CRIF:</strong> crifhighmark.com → Dispute Centre</p><p className="mt-2">File disputes with all relevant bureaus simultaneously — an error may appear on one or all four reports.</p></> },
