...
export const BLOG_POSTS: Record<string, BlogPostData> = {
  ...
  "how-to-improve-cibil-score": {
    ...
    excerpt: "Your CIBIL score determines whether you get a loan and at what rate. With a structured approach, most people can improve their score by 80–150 points in just six months.",
    relatedSlugs: ["remov-write-off-from-cibil-report", "cheque-bounce-affect-cibil", "debt-to-income-ratio"],
    faqs: [
    ...
    relatedSlugs: ["remov-write-off-from-cibil-report", "cheque-bounce-affect-cibil", "demystifying-cash-credit-and-overdraft"],
    content: (
      <article>
