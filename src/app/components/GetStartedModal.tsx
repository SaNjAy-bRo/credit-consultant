...
%%EOF`;
  ...
  const Header = ({ subtitle }: { subtitle: string }) => (
    <div className="bg-gradient-to-r from-teal-600 to-teal-900 px-6 py-5 flex items-center justify-between">
      <div className="flex items-center gap-3">
        <img src={cibilLogo} alt="Credit Consultant" className="h-8 w-auto object-contain brightness-0 invert" />
