...
export function Root() {
  ...
  return (
    <div className="min-h-screen flex flex-col w-full overflow-x-hidden pb-16 sm:pb-0">
      ...
      {/* Full-Width Bottom Sticky Bar */}
      <div
        className="fixed bottom-0 left-0 right-0 w-full z-[9999] bg-slate-950/95 backdrop-blur-xl border-t border-slate-800 shadow-2xl p-2.5 sm:p-3 px-3 sm:px-6 flex items-center justify-center gap-2.5 sm:gap-4 transition-all duration-300"
        style={{ fontFamily: "'Google Sans Flex', 'Google Sans', sans-serif" }}
      >
        <div className="max-w-4xl w-full mx-auto flex items-center gap-2.5 sm:gap-4">
          <button
            onClick={() => setScoreModalOpen(true)}
            className="flex-1 h-13 sm:h-14 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-slate-950 font-medium text-sm sm:text-lg uppercase tracking-wider rounded-xl shadow-lg shadow-orange-500/20 transition-all flex items-center justify-center gap-2.5 whitespace-nowrap active:scale-[0.98] border border-amber-300/40"
          >
            <TrendingUp className="w-5.5 h-5.5 text-slate-950 stroke-[2] flex-shrink-0" />
          ...
          <a
            ...
            className="flex-1 h-13 sm:h-14 bg-[#25D366] hover:bg-[#20bd5a] text-slate-950 font-medium text-sm sm:text-lg uppercase tracking-wider rounded-xl shadow-lg shadow-[#25D366]/20 transition-all flex items-center justify-center gap-2.5 whitespace-nowrap active:scale-[0.98]"
          >
            <svg viewBox="0 0 24 24" className="w-5.5 h-5.5 fill-slate-950 text-slate-950 flex-shrink-0">
