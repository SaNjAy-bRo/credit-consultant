    ...
    <div className="min-h-screen flex flex-col w-full overflow-x-hidden pb-16 sm:pb-0">
      ...
      >
        <button
          ...
          className="w-1/2 h-14 sm:h-16 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-slate-950 font-bold text-xs sm:text-base lg:text-lg uppercase tracking-wider transition-all flex items-center justify-center gap-2 sm:gap-3 whitespace-nowrap active:opacity-90 rounded-none border-none"
        >
          <TrendingUp className="w-5 h-5 sm:w-5.5 sm:h-5.5 text-slate-950 stroke-[2.5] flex-shrink-0" />
        ...
        <a
          ...
          className="w-1/2 h-14 sm:h-16 bg-[#25D366] hover:bg-[#20bd5a] text-slate-950 font-bold text-xs sm:text-base lg:text-lg uppercase tracking-wider transition-all flex items-center justify-center gap-2 sm:gap-3 whitespace-nowrap active:opacity-90 rounded-none border-none"
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-5.5 sm:h-5.5 fill-slate-950 text-slate-950 flex-shrink-0">
